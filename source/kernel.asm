;SAMPAOS --- The SAMPA OS Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE SAMPAOS_VER '1.0.0'	 ;OS version number
	%DEFINE SAMPAOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	os_init_msg		db '*************************Welcome to SAMPA OS****************************', 0
	os_version_msg		db 'Version ', SAMPAOS_VER, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', SAMPAOS_VER, 0

	dialog_string_1		db 'Welcome to SAMPA Operating System', 0
